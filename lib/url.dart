...
String kAddUser = kRootApi + "/mobileadduser";
String kAddEmp = kRootApi + "/org/addemployee/";
String kCity = kRootApi + "/city";
String kDepartment = kRootApi + "/selecttype";
String kSendOtp = kRootApi + "/sendotp/";
String kCheckOtp = kRootApi + "/logincheck/";
...
String kTodayPresentEmpList = kRootApi + "/org/todayspresentemplist/";
String kTodayVisitor = kRootApi + "/org/todayvisitorlist/";

String kVisitorOneMonthList = kRootApi + "/org/visitoronemonthlist/";
String kLatLngCheck = kRootApi + "/org/islatlongpresentornot/";
String kUploadEmpExcel = kRootApi + "/org/uploademployeeexcel/";
String kMonthlyAttendance = kRootApi + "/org/attendance/";
String kEmployeeList = kRootApi + "/org/employeelist/";
String kDropDownListForAttendance =
    kRootApi + "/org/dropdownlistforattendance/";

//QR Code Management URL's
String kDeleteQRCodePoint = kRootApi + "/org/deleteqrcodepoint/";
...
String kUpdateBranch = kRootApi + "/branch/updatebranch/";
String kAddBranch = kRootApi + "/branch/addsubbranch/";
